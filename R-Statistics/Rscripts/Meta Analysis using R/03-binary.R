...
## using the metabin function with arguments sm="OR" (i.e. summary measure is the Odds Ratio) 
## and method="I" (i.e.Inverse variance method).


# 1. Read in the data
data7 <- read.csv("C:/Users/zbai/Desktop/R_ZBA/Meta Analysis using R/dataset07.csv")
# 2. Display data
data7
...
# 1. Read in the data
data8 <- read.csv("C:/Users/zbai/Desktop/R_ZBA/Meta Analysis using R/dataset08.csv")
# 2. Print dataset
data8
