...
# 1. Read in the data
data1 <- read.csv("C:/Users/zbai/Desktop/R_ZBA/Meta Analysis using R/dataset01.csv", as.is=TRUE)
...
# 1. Read in the data:
data2 <- read.csv("C:/Users/zbai/Desktop/R_ZBA/Meta Analysis using R/dataset02.csv")
...
# pdf(file="Schwarzer-Fig2.6.pdf", width=11.0) 
...
# 1. Read in the data:
data3 <- read.csv("C:/Users/zbai/Desktop/R_ZBA/Meta Analysis using R/dataset03.csv")
# 2. As usual, to view an object, type its name:
data3
...
# 1. Read in the data
data4 <- read.csv("C:/Users/zbai/Desktop/R_ZBA/Meta Analysis using R/dataset04.csv")
# 2. Print data
data4
...
# 1. Read in the data
data5 <- read.csv("C:/Users/zbai/Desktop/R_ZBA/Meta Analysis using R/dataset05.csv")
# 2. Print data
data5
...
# 1. Read in the data
data6 <- read.csv("C:/Users/zbai/Desktop/R_ZBA/Meta Analysis using R/dataset06.csv")
# 2. Print data
data6
